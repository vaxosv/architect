...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return MenuColors; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Logo; });
var MenuColors;
(function (MenuColors) {
    MenuColors["darck"] = "header header-darck";
    MenuColors["white"] = "header";
})(MenuColors || (MenuColors = {}));
var Logo;
(function (Logo) {
    Logo[Logo["white"] = 0] = "white";
    Logo[Logo["darck"] = 1] = "darck";
})(Logo || (Logo = {}));
...
/* harmony import */ var _main_enums__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _helpers_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
var Header = /** @class */ (function () {
    ...
    Header.prototype.eventLIstners = function () {
        var _this = this;
        document.getElementById('menu').addEventListener('click', function () {
            if ($('.burger').hasClass('burgerActive')) {
                ...
                _this.deactivvateManu();
            }
        });
    };
    ;
    Header.prototype.activteMenu = function () {
        ...
        if (this.menuConfig.logo === _main_enums__WEBPACK_IMPORTED_MODULE_0__[/* Logo */ "a"].darck) {
            menu.removeClass('burgerActive-darck');
            menu.addClass('burgerActive-white');
        }
        Object(_helpers_helper__WEBPACK_IMPORTED_MODULE_1__[/* toggleBodyFIx */ "b"])();
    };
    Header.prototype.deactivvateManu = function () {
        if (!this.menuConfig.transparent) {
    ...
    Header.prototype.setMenuColor = function (menuClors) {
        if (this.menuConfig.menuColors === _main_enums__WEBPACK_IMPORTED_MODULE_0__[/* MenuColors */ "b"].darck) {
            $('#headerContainer').addClass('white');
        }
        $('#headerContainer').addClass(menuClors);
    };
    Header.prototype.corretLogo = function () {
        if (this.menuConfig.logo === _main_enums__WEBPACK_IMPORTED_MODULE_0__[/* Logo */ "a"].darck) {
    ...
    Header.prototype.correctBurger = function () {
        if (this.menuConfig.logo === _main_enums__WEBPACK_IMPORTED_MODULE_0__[/* Logo */ "a"].darck) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ellipsizeTextBox; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return toggleBodyFIx; });
function ellipsizeTextBox(elementLinkName, elementLink, el, text, elementRead, length, fullText) {
...
var about = /** @class */ (function () {
    ...
    about.prototype.loading = function () {
        jquery__WEBPACK_IMPORTED_MODULE_0__('#header')
            .find('#headerContainer')
            .css('z-index', -1);
        jquery__WEBPACK_IMPORTED_MODULE_0__('.filters-container').css('z-index', 1);
        jquery__WEBPACK_IMPORTED_MODULE_0__('body').css('overflow', 'hidden');
        jquery__WEBPACK_IMPORTED_MODULE_0__('html').css('overflow', 'hidden');
        jquery__WEBPACK_IMPORTED_MODULE_0__('html').scrollTop(0);
        window['imagesLoaded'](document.querySelectorAll('image'), function () {
            jquery__WEBPACK_IMPORTED_MODULE_0__('#header')
                .find('#headerContainer')
                .css('z-index', 2);
            jquery__WEBPACK_IMPORTED_MODULE_0__('filters-container').css('z-index', 4);
            jquery__WEBPACK_IMPORTED_MODULE_0__('.loader').addClass('loader-done');
            jquery__WEBPACK_IMPORTED_MODULE_0__('body').css('overflow', 'visible');
            jquery__WEBPACK_IMPORTED_MODULE_0__('html').css('overflow', 'visible');
        });
    };
    about.prototype.setMargin = function () {
        if (window.innerWidth <= 1024) {
            var left = jquery__WEBPACK_IMPORTED_MODULE_0__('.sliderContainer').first().children().first().children().position().left;
            jquery__WEBPACK_IMPORTED_MODULE_0__('.stafHeader > h2').css({
                marginLeft: left
            });
            jquery__WEBPACK_IMPORTED_MODULE_0__('.aboutContainer > h2').css({
                marginLeft: left - 15
            });
        }
    };
...
/* harmony import */ var _helpers_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
...
var News = /** @class */ (function () {
    ...
    News.prototype.loading = function () {
        jquery__WEBPACK_IMPORTED_MODULE_1__('#header')
            .find('#headerContainer')
            .css('z-index', -1);
        jquery__WEBPACK_IMPORTED_MODULE_1__('.filters-container').css('z-index', 1);
        jquery__WEBPACK_IMPORTED_MODULE_1__('body').css('overflow', 'hidden');
        jquery__WEBPACK_IMPORTED_MODULE_1__('html').css('overflow', 'hidden');
        jquery__WEBPACK_IMPORTED_MODULE_1__('html').scrollTop(0);
        window['imagesLoaded'](document.querySelectorAll('img'), function () {
            jquery__WEBPACK_IMPORTED_MODULE_1__('#header')
                .find('#headerContainer')
                .css('z-index', 2);
            jquery__WEBPACK_IMPORTED_MODULE_1__('filters-container').css('z-index', 4);
            jquery__WEBPACK_IMPORTED_MODULE_1__('.loader').addClass('loader-done');
            jquery__WEBPACK_IMPORTED_MODULE_1__('body').css('overflow', 'visible');
            jquery__WEBPACK_IMPORTED_MODULE_1__('html').css('overflow', 'visible');
        });
    };
    News.prototype.threeDots = function () {
        jquery__WEBPACK_IMPORTED_MODULE_1__('.newsDescription').each(function (i, el) {
            var element = jquery__WEBPACK_IMPORTED_MODULE_1__(el);
            var elementText = element.data('text');
            var elementRead = element.data('read');
            var elementLink = element.data('link');
            var elementLinkName = element.data('lnmae');
            Object(_helpers_helper__WEBPACK_IMPORTED_MODULE_0__[/* ellipsizeTextBox */ "a"])(elementLinkName, elementLink, element, elementText, elementRead, 255, false);
        });
    };
    News.prototype.eventListeners = function () {
        jquery__WEBPACK_IMPORTED_MODULE_1__('.readMore').on('click', function (event) {
            var element = jquery__WEBPACK_IMPORTED_MODULE_1__(event.target).parent();
            var elementText = element.data('text');
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Projects; });
var Projects = /** @class */ (function () {
    ...
    Projects.prototype.getDevice = function () {
    ...
    Projects.prototype.mobile = function () {
        var _this = this;
        $('#headerContainer')
            .find('.filter')
            .on('click', function (e) {
    ...
    Projects.prototype.mobileEventListeners = function () {
    ...
    Projects.prototype.mobileOn = function () {
        $('#filters-mobile').show();
        var cover = $('body');
        cover.addClass('openFilter');
    };
    Projects.prototype.mobileOff = function () {
        var cover = $('body');
        cover.removeClass('openFilter');
        $('#filters-mobile').hide();
    };
    Projects.prototype.setPositions = function () {
        $('.filter-head').each(function (i, el) {
            var width = $(this).innerWidth();
            var leftSide = $(this).position().left;
            var rightSide = window.innerWidth - (leftSide + width);
...
/* harmony import */ var _project_gallery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);
...
var projectItem = /** @class */ (function () {
    function projectItem() {
        this.loader();
        new _project_gallery__WEBPACK_IMPORTED_MODULE_0__[/* ProjectGallery */ "a"]();
    }
    projectItem.prototype.loader = function () {
        jquery__WEBPACK_IMPORTED_MODULE_1__('#header')
            .find('#headerContainer')
            .css('z-index', -1);
        jquery__WEBPACK_IMPORTED_MODULE_1__('.filters-container').css('z-index', 1);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProjectGallery; });
/* harmony import */ var _assets_js_tini__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var hammerjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
...
var ProjectGallery = /** @class */ (function () {
    ...
    ProjectGallery.prototype.init = function () {
        ...
        this.slider2 = Object(_assets_js_tini__WEBPACK_IMPORTED_MODULE_0__[/* tns */ "a"])({
    ...
    ProjectGallery.prototype.showSlider = function () {
        var _this = this;
        var rate = 800;
        ...
        $('.detailed-gallery .scroll').on('mousewheel', function (e) {
            if (Date.now() - lastClick >= rate) {
                ...
                if (up) {
                    ...
                    _this.slider2.goTo('prev');
                }
                if (down) {
                    _this.slider.goTo('next');
                    _this.slider2.goTo('next');
                }
                var info = _this.slider.getInfo();
                var info2 = _this.slider2.getInfo();
                var currentIndex = info.navCurrentIndex;
                var currentIndex2 = info2.navCurrentIndex;
                _this.setActiveTab(currentIndex || currentIndex2);
                lastClick = Date.now();
            }
    ...
    ProjectGallery.prototype.footer = function () {
        var info = this.slider.getInfo();
        var info2 = this.slider2.getInfo();
        var activeIndex = info.navCurrentIndex + 1;
        var activeIndex2 = info2.navCurrentIndex + 1;
        var totalCount = info.slideCount;
        var totalCount2 = info2.slideCount;
        var back = $('.slider-counter > .active-index');
        var next = $('.slider-counter > .total-count');
...
var Contact = /** @class */ (function () {
    ...
    Contact.prototype.modifySCC = function () {
        jquery__WEBPACK_IMPORTED_MODULE_0__('body').css('height', '100vh');
    };
    return Contact;
}());
...
// EXTERNAL MODULE: ./assets/js/tini.js
var tini = __webpack_require__(3);

// CONCATENATED MODULE: ./ts/slider.ts


var slider_slider = /** @class */ (function () {
    function slider() {
        this.initSlider();
        this.alignItemsCenter();
        // this.loop()
    }
    slider.prototype.handleFocus = function (slider) {
        jquery(document).ready(function () {
            jquery(window).one("focus", SomeFocusMethod);
        });
        var SomeFocusMethod = function () {
            slider.play();
            jquery(window).one("blur", SomeBlurMethod);
        };
    ...
    slider.prototype.initSlider = function () {
        ...
        slider.events.on('transitionStart', function (e, name) {
            _this.customizedFunction(e, name);
            _this.getActiveButton(e);
            if (window.innerWidth >= 1024) {
                _this.animation(e);
            }
        });
        slider.events.on('transitionEnd', function (e, name) {
        });
        // slider.pause()
        // slider.play()
        this.loading();
    };
    slider.prototype.loading = function () {
        jquery('#header')
            .find('#headerContainer')
            .css('z-index', -1);
        ...
        window['imagesLoaded'](document.querySelectorAll('item'), function () {
            jquery('#header')
                .find('#headerContainer')
                .css('z-index', 2);
            jquery('filters-container').css('z-index', 4);
            jquery('.loader').addClass('loader-done');
            jquery('body').css('overflow', 'visible');
        });
    };
    slider.prototype.createButtons = function (slider) {
        var slides = slider.slideCount;
        for (var i = 0; i <= slides; i++) {
            var div = jquery('<div/>', {
                "class": 'smallControl',
            });
            jquery('.slideCOntrolers').append(div);
        }
    };
    slider.prototype.customizedFunction = function (info, eventName) {
        var indexPrev = info.indexCached;
        var indexCurrent = info.index;
        var header = info.slideItems[indexCurrent].children[0].textContent;
        var description = info.slideItems[indexCurrent].children[1].textContent;
        this.drawSlietext(header, description);
    };
    slider.prototype.getActiveButton = function (info) {
        var index = info.displayIndex;
        var slides = document.getElementsByClassName('smallControl');
    ...
    slider.prototype.alignItemsCenter = function () {
        this.sliderItemDom = document.getElementById('sliderItemCOunt');
        var forDom = this.sliderItemDom.offsetWidth / 2;
        this.sliderItemDom.style.cssText = "left: calc(50% - " + forDom + "px);";
    };
    slider.prototype.drawSlietext = function (header, description) {
        jquery('.textHeader').text(header);
        jquery('.textOharagraph').text(description);
    };
    slider.prototype.animation = function (info) {
        var div = jquery('.home-slider-description');
        div.animate({
            left: "-=250",
            opacity: 0
        }, function () {
...
// CONCATENATED MODULE: ./ts/home.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return home_Home; });


var home_Home = /** @class */ (function () {
    function Home() {
        new slider_slider();
        jquery('.item').height(window.innerHeight);
    }
    return Home;
}());
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _home__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _about__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
/* harmony import */ var _news__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
/* harmony import */ var _main_enums__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1);
/* harmony import */ var _projects__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7);
/* harmony import */ var _projectItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8);
/* harmony import */ var _contact__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(10);
...
var App = /** @class */ (function () {
    function App() {
        ...
        switch (page) {
            case 'home':
                new _home__WEBPACK_IMPORTED_MODULE_0__[/* Home */ "a"]();
                new _header__WEBPACK_IMPORTED_MODULE_1__[/* Header */ "a"]({ menuColors: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* MenuColors */ "b"].white, logo: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* Logo */ "a"].white, shwFiltr: false, transparent: true });
                break;
            case 'about':
                new _about__WEBPACK_IMPORTED_MODULE_2__[/* about */ "a"]();
                new _header__WEBPACK_IMPORTED_MODULE_1__[/* Header */ "a"]({ menuColors: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* MenuColors */ "b"].darck, logo: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* Logo */ "a"].darck, shwFiltr: false });
                break;
            case 'projects':
                new _projects__WEBPACK_IMPORTED_MODULE_5__[/* Projects */ "a"]();
                new _header__WEBPACK_IMPORTED_MODULE_1__[/* Header */ "a"]({ menuColors: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* MenuColors */ "b"].darck, logo: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* Logo */ "a"].darck, shwFiltr: true });
                break;
            case 'news':
                new _news__WEBPACK_IMPORTED_MODULE_3__[/* News */ "a"]();
                new _header__WEBPACK_IMPORTED_MODULE_1__[/* Header */ "a"]({ menuColors: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* MenuColors */ "b"].darck, logo: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* Logo */ "a"].darck, shwFiltr: false });
                break;
            case 'projectItem':
                new _projectItem__WEBPACK_IMPORTED_MODULE_6__[/* projectItem */ "a"]();
                new _header__WEBPACK_IMPORTED_MODULE_1__[/* Header */ "a"]({ menuColors: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* MenuColors */ "b"].darck, logo: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* Logo */ "a"].darck, shwFiltr: false });
                break;
            case 'contact':
                new _contact__WEBPACK_IMPORTED_MODULE_7__[/* Contact */ "a"]();
                new _header__WEBPACK_IMPORTED_MODULE_1__[/* Header */ "a"]({ menuColors: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* MenuColors */ "b"].darck, logo: _main_enums__WEBPACK_IMPORTED_MODULE_4__[/* Logo */ "a"].darck, shwFiltr: false });
                break;
            default:
        }
        this.initLoading();
        var size = $('.main-font-size').data('textsize');
    }
